          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-white">Your Diagnosis History</h2>
              </div>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">No diagnoses yet</h3>
                  <p className="text-gray-400 mb-6 max-w-md mx-auto">
                    You haven't performed any skin diagnoses yet. Start your first analysis to track your skin health.
                  </p>
                  <Button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {history.map((item) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-medium text-white">View Diagnosis Results</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg col-span-2">
                <h3 className="font-semibold text-white mb-4">Skin Health Tips</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 rounded-full bg-diagnosphere-primary mt-2 mr-3"></span>
                    <span className="text-white/80 text-sm">Moisturize daily to maintain your skin's protective barrier and prevent dryness.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 rounded-full bg-diagnosphere-primary mt-2 mr-3"></span>
                    <span className="text-white/80 text-sm">Apply sunscreen with at least SPF 30 every day, even when it's cloudy.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 rounded-full bg-diagnosphere-primary mt-2 mr-3"></span>
                    <span className="text-white/80 text-sm">Stay hydrated by drinking 8-10 glasses of water daily for naturally glowing skin.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 rounded-full bg-diagnosphere-primary mt-2 mr-3"></span>
                    <span className="text-white/80 text-sm">Get 7-8 hours of sleep each night to allow your skin to repair and regenerate.</span>
                  </li>
                </ul>
              </div>
            </div>
