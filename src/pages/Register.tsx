          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-xs text-gray-400">
                By creating an account, you agree to our <a href="#" className="text-diagnosphere-primary hover:underline">Terms of Service</a> and <a href="#" className="text-diagnosphere-primary hover:underline">Privacy Policy</a>.
              </div>
            ...
            <div className="mt-6 text-center text-gray-400 text-sm">
              <p>
                ...
                <Link to="/login" className="text-diagnosphere-primary hover:underline">
                  Log in
                </Link>
              </p>
            </div>
