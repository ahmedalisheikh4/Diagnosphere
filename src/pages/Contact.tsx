        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-white/70">Get in touch with the Diagnosphere team</p>
            </div>
              ...
              <div>
                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-8 h-full">
                  ...
                  <div className="space-y-6 text-white/80">
                    <p>
                      Have questions about our technology, need help with the app, or want to explore partnership opportunities? 
                      We'd love to hear from you.
                    </p>
                    
                    <div>
                      <h3 className="text-white font-medium mb-1">Email</h3>
                      <p className="text-diagnosphere-primary">contact@diagnosphere.com</p>
                    </div>
                    
                    <div>
                      <h3 className="text-white font-medium mb-1">Location</h3>
                      <p>123 Health Tech Plaza<br />San Francisco, CA 94103</p>
                    </div>
                    
                    <div>
                      <h3 className="text-white font-medium mb-1">Hours</h3>
                      <p>Monday - Friday: 9am - 6pm PT<br />Saturday - Sunday: Closed</p>
                    </div>
                  </div>
                </div>
              </div>
